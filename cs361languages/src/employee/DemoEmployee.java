...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints PART TIME EMPLOYEE because it was implicitly cast
		// emp3.getHourlyRate(); // returns syntax error because the Employee class does not have that method
		...
		// because the Employee class cannot be downcast to PartTimeEmployee
